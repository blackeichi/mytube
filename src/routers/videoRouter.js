...
import { protectorMiddleware, videoUpload,uploadFiles } from "../middlewares";
...
videoRouter.route("/CreateVideoThumb").get(makeThumbnail).post(videoUpload.single("makethumb"),postmakeThumbnail);
